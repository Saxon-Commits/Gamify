                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-2">
                                    <input
                                        ...
                                        onChange={(e) => setLocalBannerMsg(e.target.value)}
                                    />
                                    <button onClick={handleSetBanner} className="bg-blue-600 hover:bg-blue-500 text-white px-4 rounded text-xs font-bold">SET</button>
                                </div>
