...
// Pricing Tiers (Gems) - Updated to rarity-based pricing
const GEM_COST = {
    COMMON: 100,      // Common items
    RARE: 400,        // Rare items
    LEGENDARY: 1000   // Legendary items
};
...
export const NEW_COMPANIONS: InventoryItem[] = [
    ...
    {
        id: 'companion-astral-fox',
        name: 'Astral Fox',
        description: 'A celestial guardian from the stars.',
        type: 'COMPANION',
        rarity: 'LEGENDARY',
        cost: 1500,
        currency: 'GOLD',
        acquiredAt: '',
        quantity: 1,
        imageUrl: '/companions/new companions/astral fox.png'
    },
    {
        id: 'companion-chrono-moth',
        name: 'Chrono Moth',
        description: 'A creature that exists across multiple timelines.',
        type: 'COMPANION',
        rarity: 'RARE',
        cost: 800,
        currency: 'GOLD',
        acquiredAt: '',
        quantity: 1,
        imageUrl: '/companions/new companions/Chrono-Moth.png'
    },
    {
        id: 'companion-cyber-raven',
        name: 'Cyber Raven',
        description: 'An augmented corvid with glowing circuits.',
        type: 'COMPANION',
        rarity: 'RARE',
        premiumPrice: 550,
        currency: 'GEMS',
        acquiredAt: '',
        quantity: 1,
        imageUrl: '/companions/new companions/enhanced raven.png'
    },
    {
        id: 'companion-forest-spirit',
        name: 'Forest Spirit',
        description: 'A mystical guardian of the woods.',
        type: 'COMPANION',
        rarity: 'COMMON',
        premiumPrice: 200,
        currency: 'GEMS',
        acquiredAt: '',
        quantity: 1,
        imageUrl: '/companions/new companions/forest spirit.png'
    },
    {
        id: 'companion-black-drake',
        name: 'Black Drake',
        description: 'A shadow dragon cloaked in darkness.',
        type: 'COMPANION',
        rarity: 'LEGENDARY',
        premiumPrice: 1200,
        currency: 'GEMS',
        acquiredAt: '',
        quantity: 1,
        imageUrl: '/companions/new companions/black dragon.png'
    },
    {
        id: 'companion-emerald-drake',
        name: 'Emerald Drake',
        description: 'A majestic dragon wreathed in verdant scales.',
        type: 'COMPANION',
        rarity: 'LEGENDARY',
        premiumPrice: 1300,
        currency: 'GEMS',
        acquiredAt: '',
        quantity: 1,
        imageUrl: '/companions/new companions/green dragon.png'
    },
    {
        id: 'companion-molten-golem',
        name: 'Molten Golem',
        description: 'A fiery construct of living stone.',
        type: 'COMPANION',
        rarity: 'RARE',
        premiumPrice: 650,
        currency: 'GEMS',
        acquiredAt: '',
        quantity: 1,
        imageUrl: '/companions/new companions/Molten Golem.png'
    },
    {
        id: 'companion-nano-sentinel',
        name: 'Nano Sentinel',
        description: 'A swarm of microscopic guardians.',
        type: 'COMPANION',
        rarity: 'RARE',
        premiumPrice: 500,
        currency: 'GEMS',
        acquiredAt: '',
        quantity: 1,
        imageUrl: '/companions/new companions/nano sentinel.png'
    },
    {
        id: 'companion-crimson-drake',
        name: 'Crimson Drake',
        description: 'A fierce dragon wreathed in flames.',
        type: 'COMPANION',
        rarity: 'LEGENDARY',
        premiumPrice: 1100,
        currency: 'GEMS',
        acquiredAt: '',
        quantity: 1,
        imageUrl: '/companions/new companions/red dragon.png'
    },
    {
        id: 'companion-void-imp',
        name: 'Void Imp',
        description: 'A mischievous creature from the dark dimensions.',
        type: 'COMPANION',
        rarity: 'COMMON',
        cost: 300,
        currency: 'GOLD',
        acquiredAt: '',
        quantity: 1,
        imageUrl: '/companions/new companions/void imp.png'
    },
    {
...
// Include starter avatars in the shop
export const COSMETIC_SHOP_ITEMS_WITH_STARTERS = [...COSMETIC_SHOP_ITEMS, ...STARTER_AVATARS];
